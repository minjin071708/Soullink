import { getMoodImage, getMoodLabelKey } from "@/components/home/weeklyJournalMock";
...
export type HomeWeeklyJournalCardProps = {
  selectedDate: string;
  weekDays: WeekDayItem[];
  selectedJournal: WeeklyJournalPreview | null;
      ...
      >
        ...
        <Text
          style={[
            ...
            selected ? styles.weekDayNumberSelected : styles.weekDayNumberDefault,
          ]}
        >
          {day.dayNumber}
        </Text>
...
const JournalPreviewCard = memo(function JournalPreviewCard({
  ...
  const moodImage = journal?.moodId ? getMoodImage(journal.moodId) : CLOUD_MASCOT;
  ...
  return (
    ...
    >
      ...
      <View style={styles.heartFloating} pointerEvents="none">
        <Ionicons name="heart" size={18} color="#F08BB0" />
      </View>
    </Animated.View>
  );
});

export function HomeWeeklyJournalCard({
  selectedDate,
  weekDays,
  selectedJournal,
  onSelectDay,
  onViewCalendar,
}: HomeWeeklyJournalCardProps) {
